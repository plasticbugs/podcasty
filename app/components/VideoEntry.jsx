...
const VideoEntry = (props) => {
  let downloadOrPercent = props.video.percent === "100%" ? <DownloadButton link={props.video.snippet.resourceId.videoId} channel={props.channel} /> : <Percent total={props.video.percent} />;
  return (
